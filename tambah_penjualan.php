                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <table width="800px">
                                            <form class="user" action="insert_penjualan.php" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-user" name="nama_barang">
                                                            </div>
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <div class="form-group">
                                                                <input type="date" class="form-control form-control-user" name="tanggal_penjualan">
                                                            </div>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-user" name="jumlah_penjualan">
                                                            </div>
                                                    </tr>
